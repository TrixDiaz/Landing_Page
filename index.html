          ...
          <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-3 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="img/angel.jpg" alt="" class="img-fluid rounded-circle">
                        <h3 class="card-title py-2">Angel Darlucio</h3>
                        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi ipsam nostrum illo tempora esse quibusdam.</p>
                        <p class="socials">
                            <i class="bi bi-twitter text-dark mx-1"></i>
                        <i class="bi bi-facebook text-dark mx-1"></i>
                ...
                <div class="col-12 col-md-6 col-xl-3 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="img/mariecar.jpg" alt="" class="img-fluid rounded-circle">
                        <h3 class="card-title py-2">Mariecar Darlucio</h3>
                        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi ipsam nostrum illo tempora esse quibusdam.</p>
                        <p class="socials">
                            <i class="bi bi-twitter text-dark mx-1"></i>
                        <i class="bi bi-facebook text-dark mx-1"></i>
                ...
                <div class="col-12 col-md-6 col-xl-3 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="img/mayang.jpg" alt="" class="img-fluid rounded-circle">
                        <h3 class="card-title py-2">Mary Alvarez</h3>
                        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi ipsam nostrum illo tempora esse quibusdam.</p>
                        <p class="socials">
                            <i class="bi bi-twitter text-dark mx-1"></i>
                        <i class="bi bi-facebook text-dark mx-1"></i>
